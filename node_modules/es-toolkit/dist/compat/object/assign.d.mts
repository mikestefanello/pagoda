 ...
 */
declare function assign<O, S>(object: O, source: S): O & S;
/**
 ...
 */
declare function assign<O, S1, S2>(object: O, source1: S1, source2: S2): O & S1 & S2;
/**
 ...
 */
declare function assign<O, S1, S2, S3>(object: O, source1: S1, source2: S2, source3: S3): O & S1 & S2 & S3;
/**
 ...
 */
declare function assign<O, S1, S2, S3, S4>(object: O, source1: S1, source2: S2, source3: S3, source4: S4): O & S1 & S2 & S3 & S4;
/**
 ...
 * console.log(result); // Output: { a: 1, b: 2, c: 3 }
 */
declare function assign(object: any, ...sources: any[]): any;
